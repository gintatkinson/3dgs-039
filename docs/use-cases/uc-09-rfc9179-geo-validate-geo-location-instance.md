...
- [ ] #38 - [RFC9179-GEO Ellipsoid Coordinate Location](https://github.com/gintatkinson/3dgs-039/blob/main/docs/features/feat-15-rfc9179-geo-ellipsoid-coordinate-location.md) (defines latitude dec64 fr16, longitude dec64 fr16, and height dec64 fr6 whose precision ceilings and mutual-exclusivity constraint are enforced by this use case)
- [ ] #39 - [RFC9179-GEO Cartesian Coordinate Location](https://github.com/gintatkinson/3dgs-039/blob/main/docs/features/feat-16-rfc9179-geo-cartesian-coordinate-location.md) (defines x/y/z dec64 fr6 and the Cartesian case of the location choice — the complementary branch of the exclusive choice enforced by this use case)
- [ ] #40 - [RFC9179-GEO Velocity Vector](https://github.com/gintatkinson/3dgs-039/blob/main/docs/features/feat-17-rfc9179-geo-velocity-vector.md) (defines v-north/v-east/v-up dec64 fr12 whose precision ceilings are enforced by this use case during instance validation)
- [ ] #41 - [RFC9179-GEO Temporal Location Attributes](https://github.com/gintatkinson/3dgs-039/blob/main/docs/features/feat-18-rfc9179-geo-temporal-location-attributes.md) (defines timestamp and valid-until leaves using yang:date-and-time whose format compliance and chronological envelope are validated by this use case)
